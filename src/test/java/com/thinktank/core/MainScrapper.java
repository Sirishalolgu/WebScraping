			...
			for (int j = 0; j <= last_page_number - 1; j++) {
				...
				for (int i = 0; i < recipeNames.size(); i++) {
					...
					try {
						...
						LinkedList<String> output = populateRecipeDetails(driver, doc, targettedMorbids, ingredidentList);
...
//**********************************************************************************************************//	
	...
	private static LinkedList<String> populateRecipeDetails(WebDriver driver, Document doc, List<String> targettedMorbids,
